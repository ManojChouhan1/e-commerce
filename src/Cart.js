                                        ...
                                        <tbody>
                                            <tr className="cart_item">
                                                <td className="product-thumbnail" data-title="Thumbnail">
                                                    <Link to="/product-single"><img src="assets/images/cart-1.jpg" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" /></Link>
                                                </td>

                                                <td className="product-name" data-title="Product">
                                                    <Link to="#">Trendy Cloth</Link>
                                                </td>
                                                ...
                                                <td className="product-remove" data-title="Remove">
                                                    <Link to="#" className="remove" aria-label="Remove this item" data-product_id="30" data-product_sku="">×</Link>
                                                </td>
                                            </tr>
                                            <tr className="cart_item">
                                                <td className="product-thumbnail" data-title="Thumbnail">
                                                    <Link to="/product-single"><img src="assets/images/cart-2.jpg" className="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" /></Link>
                                                </td>
                                                <td className="product-name" data-title="Product">
                    ...
                    <div className="row justify-content-end">
                        <div className="col-lg-4">
                            <div className="cart-info card p-4 mt-4">
                                ...
                                <Link to="#" className="btn btn-main btn-small">Proceed to checkout</Link>
                            </div>
                        </div>
                    </div>
                </div>
