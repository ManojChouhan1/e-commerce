                ...
                <div className="row">
                    <div className="col-lg-8 pr-5">
                        <div className="coupon-notice " data-toggle="modal" data-target="#coupon-modal">
                            <div className="bg-light p-3">
                                Have a coupon? <Link href="/checkout" className="showcoupon" >Click here to enter your code</Link>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="product-checkout-details mt-5 mt-lg-0">
                            ...
                            <Link href="/checkout" className="btn btn-main btn-small">Place Order</Link>
                        </div>
                    </div>
                </div>
                </div>
