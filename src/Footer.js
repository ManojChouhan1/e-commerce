                    ...
                    <div className="row">
                        <div className="col-md-6 col-lg-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left mr-auto">
                            <div className="footer-widget">
                                ...
                                <div className="">
                                    <p className="mb-0"><strong>Location : </strong>Indore M.P. ,INDIA</p>
                ...
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-6">
                            <p className="copyright mb-0 ">@ Copyright Reserved to therichpost &amp; made by <Link to="#">therichpost</Link></p>
                        </div>
                        <div className="col-lg-6">
